...
function sortHotelByPricelth(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortHotelByPricehtl(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing.toLowerCase() == 'low-to-high') {
    hotelsCopy.sort(sortHotelByPricelth);
  } else {
...
function sortHotelByRatinghtl(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating.toLowerCase() == 'low-to-high') {
    hotelsCopy.sort(sortHotelByRatinglth);
  } else {
...
function sortHotelByReviewshtl(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews.toLowerCase() == 'least-to-most') {
    hotelsCopy.sort(sortHotelByReviewslth);
  } else {
